...
public class MaterialAttributesTests
{
    ...
    public void Mandatory_parameters_should_not_null_or_empty(string name, 
        string colorCode, 
        string width, 
        string weight, 
        string unit, 
    ...
    public void Should_trim_all_properties()
    {
        ...
        var materialAttributes = MaterialAttributes.Create($" {name} ", 
            $" {colorCode} ",
            $" {width} ",
            $" {weight} ",
            $" {unit} ",
        ...
        materialAttributes.IsSuccess.Should().Be(true);
        materialAttributes.Value.Name.Should().Be(name);
